-- =============================================================
-- Artisan Services Platform - Koforidua Municipality
-- MySQL schema
-- =============================================================
...
CREATE TABLE IF NOT EXISTS artisans (
  ...
  trade         VARCHAR(80) NOT NULL,        -- Plumber, Electrician, Carpenter ...
  experience    INT NOT NULL DEFAULT 0,      -- years
  location      VARCHAR(160) NOT NULL,       -- human-readable (e.g. "Koforidua, Adweso")
  ...
  is_approved   TINYINT(1) NOT NULL DEFAULT 0,  -- admin approval gate
...
CREATE TABLE IF NOT EXISTS bookings (
  id            INT AUTO_INCREMENT PRIMARY KEY,
  client_id     INT NOT NULL,            -- users.id
  artisan_id    INT NOT NULL,            -- artisans.id
  service_id    INT DEFAULT NULL,        -- services.id (optional)
...
CREATE TABLE IF NOT EXISTS reviews (
  ...
  comment     TEXT,
  is_hidden   TINYINT(1) NOT NULL DEFAULT 0,  -- admin can hide fake reviews
  created_at  TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS payments (
  ...
  channel       VARCHAR(40) DEFAULT NULL,   -- mobile_money, card ...
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  type        VARCHAR(40) DEFAULT 'general',  -- booking, review, payment, system
...
-- ---------- OTP codes (phone verification / password reset) ----------
